...
public class Hud {
	...
	public void render(Graphics g, int reloadClock, int shellX, int shellY, int playerX, int playerY, boolean firing, int[] lifetimes, int tank_ammo, int wallx, int wally) {
		...
		g.drawString("Wall X: " + wallx + ", Wall Y: " + wally, 800, 15);
	}
